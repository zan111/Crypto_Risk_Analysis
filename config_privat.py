...
NEWS_API_KEY      = os.getenv("NEWS_API_KEY",      "bf50cc7b75754b83916fb21a04dbe560")
REDDIT_CLIENT_ID  = os.getenv("REDDIT_CLIENT_ID",  "rFyKXToYGF_NkiUS8K12NQ")
REDDIT_SECRET     = os.getenv("REDDIT_SECRET",     "TBYXsekF1lIsu_tUC5TanM14M4qluQ")
X_BEARER_TOKEN    = os.getenv(
    "X_BEARER_TOKEN",
    "AAAAAAAAAAAAAAAAAAAAALNs7wEAAAAAr0R%2BFzj%2B%2BOWs2E0tNUhToLc2XVI%3DnLekU1HIQG7"
    "oiYlt7Zb2ORis2VagTme9e9yXnvFJEvH4sEzJEI",
)
